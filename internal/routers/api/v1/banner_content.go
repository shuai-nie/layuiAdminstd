...
func NewBannerContent() BannerContent {
	return BannerContent{}
}

func (a BannerContent) Get(c *gin.Context) {
...
func (a BannerContent) List(c *gin.Context) {
...
func (a BannerContent) Create (c *gin.Context) {
...
func (a BannerContent) Update (c *gin.Context) {
	response := app.NewResponse(c)
